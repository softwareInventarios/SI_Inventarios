...
class InventarioController {
    ...
    def save(Inventario inventarioInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.created.message', args: [message(code: 'inventarioInstance.label', default: 'Inventario'), inventarioInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'inventarioInstance.label', default: 'Inventario'), params.id])
                redirect action: "index", method: "GET"
            }
