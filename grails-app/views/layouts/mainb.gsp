    ...
    <body>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">CUCSOFT</a>
            </div>
            <!-- Top Menu Items -->
                    ...
                    <li class="active">
                       ...
                       <li>
                        ...
                        <ul id="demo" class="collapse">
                            <li>
                                <a href="${createLink(uri: '/producto/')}"><i class="fa fa-fw fa-table"></i> Producto</a>
                            </li>
                            <li>
                                <a href="${createLink(uri: '/parametro/')}"><i class="fa fa-fw fa-table"></i> Parametro</a>
                            </li>
                            <li>
                                <a href="${createLink(uri: '/valorParametro/')}"><i class="fa fa-fw fa-table"></i> Valor Parametro</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a href="${createLink(uri: '/conteo/')}"><i class="fa fa-fw fa-bar-chart-o"></i> Conteo</a>
                    </li>
                    <li>
                        <a href="${createLink(uri: '/kardex/')}"><i class="fa fa-fw fa-table"></i> Kardex</a>
                    </li>
